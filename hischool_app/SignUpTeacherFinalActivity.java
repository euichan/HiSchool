 ...
 */
public class SignUpTeacherFinalActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.signup_teacher_final_activity);
        ...
        switch (v.getId())
        {
            ...
            case R.id.btn_confirm:
                if(input_name.getText().toString().equals("") ||
                    ...
                    Toast.makeText(
                            SignUpTeacherFinalActivity.this,
                            "해당 사항들은 필수사항입니다.\n 다시 채워주세요.",
                ...
                Toast.makeText(SignUpTeacherFinalActivity.this, "회원가입에 성공하였습니다!", Toast.LENGTH_SHORT).show();
                MainActivity.mInstance.finish();
                Intent it = new Intent(SignUpTeacherFinalActivity.this, MenuTeacherActivity.class);
                startActivity(it);
                finish();
                break;
        }
