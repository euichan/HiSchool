 ...
 */
public class MyBobWidget extends AppWidgetProvider {
    ...
    public void initUI(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        manager.initHelper(context);
        String todayBob = manager.select(Calendar.getInstance().get(Calendar.DAY_OF_MONTH));
        todayBob.replaceAll(" ", ", ");
        views.setTextViewText(R.id.textBob, todayBob);
