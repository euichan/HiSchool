...
public class StudentMapActivity extends NMapActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (USE_XML_LAYOUT) {
            setContentView(R.layout.student_map_acitivity);
        ...
        while(it.hasNext())
        {
            ...
            myAddMarker((double)m.get("x"), (double)m.get("y"), key);
        ...
        alt_bld.setMessage("현재시각 : " +
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        //YES
                        DataManager.getInstance(null).savePreferences("isHome","false");
                    }
                }).setNegativeButton("아니오",
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        DataManager.getInstance(null).savePreferences("isHome","true");
                        dialog.cancel();
                    }
                });
        ...
        if (mMyLocationOverlay != null) {
            ...
            if (mMapLocationManager.isMyLocationEnabled()) {
                ...
                if (!isMyLocationEnabled) {
                    Toast.makeText(StudentMapActivity.this, "Please enable a My Location source in system settings",
    ...
    private final NMapActivity.OnDataProviderListener onDataProviderListener = new NMapActivity.OnDataProviderListener() {
        ...
        public void onReverseGeocoderResponse(NMapPlacemark placeMark, NMapError errInfo) {
            ...
            if (errInfo != null) {
                ...
                Toast.makeText(StudentMapActivity.this, errInfo.toString(), Toast.LENGTH_LONG).show();
                return;
            }
    ...
    private final NMapLocationManager.OnLocationChangeListener onMyLocationChangeListener = new NMapLocationManager.OnLocationChangeListener() {
        ...
        public void onLocationUpdateTimeout(NMapLocationManager locationManager) {
            ...
            Toast.makeText(StudentMapActivity.this, "Your current location is temporarily unavailable.", Toast.LENGTH_LONG).show();
        }

        @Override
        public void onLocationUnavailableArea(NMapLocationManager locationManager, NGeoPoint myLocation) {

            Toast.makeText(StudentMapActivity.this, "Your current location is unavailable area.", Toast.LENGTH_LONG).show();
    ...
    private final NMapView.OnMapStateChangeListener onMapViewStateChangeListener = new NMapView.OnMapStateChangeListener() {
        ...
        public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
            ...
            if (errorInfo == null) { // success
                ...
                Toast.makeText(StudentMapActivity.this, errorInfo.toString(), Toast.LENGTH_LONG).show();
            }
        }
    ...
    private final NMapPOIdataOverlay.OnStateChangeListener onPOIdataStateChangeListener = new NMapPOIdataOverlay.OnStateChangeListener() {
        ...
        public void onCalloutClick(NMapPOIdataOverlay poiDataOverlay, NMapPOIitem item) {
            ...
            Toast.makeText(StudentMapActivity.this, "onCalloutClick: " + item.getTitle(), Toast.LENGTH_LONG).show();
        }
            ...
            if (itemOverlay instanceof NMapPOIdataOverlay) {
                ...
                if (!poiDataOverlay.isFocusedBySelectItem()) {
                    ...
                    if (countOfOverlappedItems > 1) {
                        ...
                        Toast.makeText(StudentMapActivity.this, text, Toast.LENGTH_LONG).show();
                        return null;
                    }
                }
            }
        ...
        public View onCreateCalloutOverlayView(NMapOverlay itemOverlay, NMapOverlayItem overlayItem, Rect itemBounds) {
            ...
            if (overlayItem != null) {
                ...
                if (title != null && title.length() > 5) {
                    return new NMapCalloutCustomOverlayView(StudentMapActivity.this, itemOverlay, overlayItem, itemBounds);
                }
            }
    ...
    private void myAddMarker(double lat,double lon, String comment) {
        ...
        poiData.addPOIitem(lat, lon, comment, markerId, 0);
        poiData.endPOIdata();
